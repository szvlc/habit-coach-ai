...
3. **Brakujące sprawdzenie impl-review**: glob `context/changes/<change-id>/reviews/impl-review*.md`. Jeśli żaden nie pasuje, dodaj do kolejki: `Nie znaleziono impl-review w reviews/impl-review*.md.`
...
- Krok zamykania roadmapy (krok 5 "Przenieś i oznacz") jest izolowany: każde niepowodzenie jest wyłapywane, odnotowywane w wyniku potwierdzenia i pomijane. Nigdy nie przerywa archiwizacji i nigdy nie wywołuje wycofania. Częściowo zastosowana edycja roadmapy jest możliwa do odzyskania ręcznie.
